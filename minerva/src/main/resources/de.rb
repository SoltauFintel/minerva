...
selectWS=Bitte wählen Sie einen Workspace.
...
error.simultaneousEditing=Gleichzeitige Bearbeitung erkannt! Bitte zurück gehen, die Änderungen speichern, Seite neu laden und Bearbeitung wiederholen.
