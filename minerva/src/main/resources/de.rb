...
exportInfo1=Bei Auswahl von "alle Bücher" werden Featurebaum und interne Bücher nicht einbezogen.
exportInfo2=Bei Auswahl von Kunde "-" werden keine tags berücksichtigt, d.h. es werden <i>alle</i> Seiten exportiert.
...
copyToWorkspaceShort=Kopiere nach Workspace
...
turnOffColoredHeadings=Farbige Überschriften ausschalten
turnOnColoredHeadings=Farbige Überschriften einschalten
Ausblenden=Ausblenden
AusblendenRueckgaengig=Ausblenden rückgängig
ZeigeAlle=Zeige auch ausgeblendete
ZeigeAktive=Zeige nur aktive
AlleEinblenden=Alle einblenden
BLSiAbfr=Alle wieder dauerhaft einblenden?
Mehrfachauswahl=Mehrfachauswahl
selectNone=Nichts auswählen
action=Aktion
execute=Ausführen
selectThesePages=Diese ${bt} Seiten auswählen
