...
reimportReleaseNotes=Release Notes erneut importieren?
ErneutImportieren=Erneut importieren
pageOnly1HelpKey=Seite muss genau einen Hilfe-Key haben!
helpKeyMustBeReleaseNumber=Der Hilfe-Key muss eine gültige Release Nummer sein!
cantGetCustomer=Kunde kann nicht ermittelt werden! Die übergeordnete Kundenseite hat kein tag "release-notes-...".
unknownCustomerCode=Kundenkürzel unbekannt! Die übergeordnete Kundenseite muss ein tag 'release-notes-' + gültiges Kundenkürzel haben!
multipleTargetVersion=Die 'Target release version' $rn gibt es mehrfach in Jira Release Tickets!
noReleaseTicket=Es gibt kein Release Ticket für Kunde $c und 'Target release version' $rn !
reimportFailed1=Reimport nicht möglich. Es wurden anhand der Page ID $p keine Release note Tickets gefunden.
