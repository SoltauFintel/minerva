...
v.webkit=Seite enthält webkit CSS Schmutz.
v.colors=Seite enthält Farbe: $0
...
editFeatureFieldsBtn=Feature bearbeiten
...
duplicatePage1=Komplette Kopie
duplicatePage0=Kopie ohne Hilfe-Keys, tags und buchübergreifende Links
duplicatePageHint=Button 1 ist sinnvoll beim Teilen einer Seite. Button 2 ist sinnvoll wenn die Seite als Vorlage dienen soll.
...
qbofftext=Zeige alle Suchergebnisse
buchfilter=Filter
...
ffe1=Feature- oder Seite-ID
ffe2=oder kompletter -Titel
ffe3=oder Feature-Nr.
...
deepSearch2=Starte die Bücher-Tiefensuche.
