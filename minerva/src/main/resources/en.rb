...
editFeatureFieldsBtn=Edit feature
...
relationsInfo=With which features/pages/websites should this feature be linked? Please make one entry per line. Not all fields have to be filled.
zuLoeschendeBeziehungenAnhaken=Delete relations
Features=Features
