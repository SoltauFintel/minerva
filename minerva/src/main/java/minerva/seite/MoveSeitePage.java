...
public class MoveSeitePage extends SPage {
    ...
    private void fillSeiten(String branch, String bookFolder, SeitenSO seiten, String lang, StringBuilder gliederung, boolean noLink) {
        ...
        for (SeiteSO seite : seiten) {
            if (noLink) {
                ...
                gliederung.append("\t<li style=\"font-weight: bold;\">" + esc(seite.getSeite().getTitle().getString(lang)) + "</li>\n");
                fillSeiten(branch, bookFolder, seite.getSeiten(), lang, gliederung, true);
