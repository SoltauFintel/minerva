...
public class QuickbuttonsPage extends UPage {
	...
	protected void execute() {
		...
		Cols cols = Cols.of(new Col("Label", "{{i.label}}"),
				new Col("", "<a href=\"/q/delete?i={{i.nr}}\" class=\"btn btn-danger btn-xs\"><i class=\"fa fa-trash-o\"></i></a>"
						+ " <a href=\"/q/move?d=-1\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-arrow-up\"></i></a>"
						+ " <a href=\"/q/move?d=1\" class=\"btn btn-default btn-xs\"><i class=\"fa fa-arrow-down\"></i></a>"));
